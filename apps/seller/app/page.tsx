...
export default function Home() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-zinc-100 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-50">
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_85%_55%_at_50%_-15%,rgb(34_197_94/0.12),transparent_55%)] dark:bg-[radial-gradient(ellipse_85%_55%_at_50%_-15%,rgb(34_197_94/0.18),transparent_55%)]"
        aria-hidden
      />
      <div
      ...
      <div className="relative mx-auto flex min-h-screen max-w-xl flex-col px-6 py-16 sm:px-8 sm:py-24">
        ...
        <DemoRequestForm
          contextLabel="Submitting as: seller.yourdomain.com"
          fullNameLabel="Seller Full name"
